...
use App\Orchid\Screens\StudentScreen;
use App\Orchid\Screens\ProfessorScreen;
/*
|--------------------------------------------------------------------------
| Dashboard Routes
|--------------------------------------------------------------------------
...
Route::screen('/students', StudentScreen::class)->name('platform.student');
Route::screen('/professors', ProfessorScreen::class)->name('platform.professor');
// Users...
